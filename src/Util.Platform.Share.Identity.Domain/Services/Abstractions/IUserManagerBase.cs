...
/// 用户服务
/// </summary>
public interface IUserManagerBase<TUser, TRole> : IUserManagerBase<TUser, Guid, TRole, Guid?>
...
public interface IUserManagerBase<TUser, TUserId, TRole, TAuditUserId> : IDomainService 
